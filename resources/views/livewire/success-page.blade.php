<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto mt-10">
    <section class="flex items-center font-poppins dark:bg-gray-800">
      <div class="justify-center flex-1 max-w-6xl px-4 py-4 mx-auto bg-white border rounded-md dark:border-gray-900 dark:bg-gray-900 md:py-10 md:px-10 mt-10">
        <div class="">
                ...
                <div class="flex flex-col items-center justify-center w-full pb-4 space-y-4 border-b border-gray-200 dark:border-gray-700">
                  <div class="flex justify-between w-full">
                    ...
                    <p class="text-base leading-4 text-gray-600 dark:text-gray-400">
                      {{ number_format($order->subtotal, 0, ',', '.') }} IDR
                    </p>
                  </div>
                  <div class="flex items-center justify-between w-full">
                    ...
                    <p class="text-base leading-4 text-gray-600 dark:text-gray-400">
                        {{ number_format($order->tax_amount, 0, ',', '.') }} IDR
                    </p>
                  </div>
                  <div class="flex items-center justify-between w-full">
                    <p class="text-base leading-4 text-gray-800 dark:text-gray-400">Shipping</p>
                    <p class="text-base leading-4 text-gray-600 dark:text-gray-400">
                        {{ number_format($order->shipping_cost, 0, ',', '.') }} IDR
                    </p>
                  </div>
                </div>
                <div class="flex items-center justify-between w-full">
                  ...
                  <div class="flex items-center justify-center space-x-2">
                    ...
                    <div class="flex flex-col items-center justify-start">
                      <p class="text-lg font-semibold leading-6 text-gray-800 dark:text-gray-400">
                        Delivery<br><span class="text-sm font-normal uppercase">{{ str_replace('_', ' ', $order->shipping_service) }}</span>
                      </p>
                    </div>
                  </div>
