                ...
                <div class="p-8">
                    <div class="mb-8 text-center">
                        ...
                        <p class="mt-2 text-sm text-gray-600">
                            ...
                            <a wire:navigate href="/signup" class="text-primary-600 hover:text-primary-500 font-medium ml-1 transition duration-150">
                                Create account
                            </a>
                        </p>
                    </div>

                    <form wire:submit.prevent="signin" class="space-y-6">
                        <div class="space-y-2">
                        ...
                        <div class="space-y-2">
                            <div class="flex justify-between">
                                ...
                                <a href="/forgot-password" class="text-sm text-primary-600 hover:text-primary-500 transition duration-150">
                                    Forgot password?
                                </a>
                            </div>
                            <div class="relative group">
...
<script>
    function onRecaptchaComplete(response) {
      ...
      if (response) {
          ...
          console.log('recaptcha response after set:', response);
          Livewire.emit('recaptchaResponse', response);
      } else {
          console.error("reCAPTCHA response is missing.");
      }
  }
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        grecaptcha.ready(function() {
            ...
            'sitekey' : '6Lfl1JsqAAAAAINdsjwG1BoyyzRCFlVYAsAmDsw0',
